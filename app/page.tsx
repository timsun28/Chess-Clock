...
export default function App() {
    ...
    return (
        <main className="min-h-svh max-h-svh overflow-y-auto bg-linear-to-b from-orange-50 via-white to-neutral-100 text-neutral-900">
            <div className="mx-auto flex min-h-svh w-full max-w-4xl flex-col px-4 pb-4 pt-3">
                <header className="mb-2 flex flex-none items-center justify-between">
                    <div>
                        <p className="text-xs uppercase tracking-[0.2em] text-orange-600">Chess clock</p>
